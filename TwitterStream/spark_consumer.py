...
def main():
    # load
    nfeeling_words = load_word_list("/home/yutongzhu9/spark/Dataset/nFeeling.txt")
    pfeeling_words = load_word_list("/home/yutongzhu9/spark/Dataset/pFeeling.txt")
    ...
    # Processing data from Kafka--library: KafkaUtils
    # topic -- [twitter-stream]
    # offset + 1 by default in this library 
